...
@section('title', 'DaftarProject Management Terbaik')
@section('content')
    <div class="acc-header col-xl-3 col-md-6 py-2 mt-4 rounded-3 d-flex justify-content-center">Project Management Terbaik
    </div>
    ...
    <div class="row">
        <div class="tabel-adm col-xl-3 col-md-6 mx-auto">
            <h4 class="pt-4 pb-3">Hasil Perhitungan Project Management Terbaik</h4>
            <div class="table-responsive w-auto">
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <th>Nama Project Management</th>
