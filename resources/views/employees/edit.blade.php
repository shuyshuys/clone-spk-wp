...
@section('content')
    <div class="acc-header col-xl-3 col-md-6 py-2 mt-4 rounded-3 d-flex justify-content-center">
        Ubah Data Project Management
    </div>
    <div class="row mt-4 mx-3 d-flex justify-content-center">
        <div class="add-admin col-12 bg-white">
            <form id="save-employee-form" action="{{ route('employees.update', $employee->uuid) }}" class="pt-5 px-md-3"
                method="post">
                @method('PUT')
                @csrf
                <div class="form-group row mb-4 px-3">
                    <label for="name" class="form-label col-md-3">Nama Project Management</label>
                    <div class="col-md-9">
                        <input type="text" name="name" id="name"
                            class="form-control form-control-lg fs-6 @error('name') is-invalid @enderror"
                            placeholder="Masukkan Nama Project Management" value="{{ old('name', $employee->name) }}"
                            required />
                        @error('name')
                ...
                <div class="form-group row mb-4 px-3">
                    ...
                    <div class="col-md-9">
                        <input type="email" name="email" id="email"
                            ...
                            placeholder="Masukkan Email Karyawan" value="{{ old('email', $employee->email) }}" required />
                        @error('email')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="form-group row mb-4 px-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="phone_number" id="phone_number"
                            class="form-control form-control-lg fs-6 @error('phone_number') is-invalid @enderror"
                ...
                <div class="form-group row mb-4 px-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="address" id="address"
                            class="form-control form-control-lg fs-6 @error('address') is-invalid @enderror"
                            placeholder="Masukkan Alamat Karyawan" value="{{ old('address', $employee->address) }}"
                            required />
                        @error('address')
                            <div class="invalid-feedback">
                                {{ $message }}
