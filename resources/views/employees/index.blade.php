...
@section('title', 'Daftar Project Management')
@section('content')
    <div class="acc-header col-xl-3 col-md-6 py-2 mt-4 rounded-3 d-flex justify-content-center">Project Management</div>
    <div class="row">
            ...
            @can('create', \App\Models\Criteria::class)
                <a href="{{ route('employees.create') }}">
                    <button type="button" class="btn btn-primary my-4">
                        ...
                        <span class="ps-2 fw-bolder"> Tambah Project Management</span>
                    </button>
                </a>
            @endcan
        </div>
    ...
    <div class="row">
        <div class="tabel-adm col-xl-3 col-md-6 mx-auto">
            <h4 class="pt-4 pb-3">Daftar Project Management</h4>
            @if (session('success'))
